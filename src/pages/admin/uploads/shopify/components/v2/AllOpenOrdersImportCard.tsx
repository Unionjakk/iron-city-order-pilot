...
interface AllOpenOrdersImportCardProps {
  onImportComplete?: () => void;
}

const AllOpenOrdersImportCard = ({ onImportComplete }: AllOpenOrdersImportCardProps) => {
  ...
  return (
    <Card className="w-full border-zinc-800 bg-zinc-900/60">
      <CardHeader>
        <CardTitle className="text-orange-500">All Open Unfulfilled Orders and Open Partial Orders Import</CardTitle>
          ...
          {isLoading && (
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-zinc-300">Importing orders...</span>
                <span className="text-zinc-300">{importedOrders} orders / {importedLines} line items</span>
              </div>
...
export default AllOpenOrdersImportCard;
