...
const HarleyStatsCard = ({
  ...
  console.log('HarleyStatsCard rendering with:', {
    stats,
    isLoading
  });
  return <div className="p-4 bg-zinc-800/60 rounded-lg border border-zinc-700">
      ...
      {isLoading ? <div className="flex justify-center py-4">
          ...
          <div className="space-y-2">
            ...
            <div>
              <span className="text-zinc-400 text-sm">Total Backorder Items:</span>
              <span className="ml-2 text-zinc-200 font-semibold">
          ...
          <div className="bg-zinc-700/40 rounded p-3">
            ...
            {stats.totalOrders > 0 ? <div className="space-y-2 text-xs text-zinc-300">
              ...
              width: `${Math.round((stats.totalOrders - stats.ordersWithoutLineItems) / stats.totalOrders * 100)}%`
            }}>
                  </div>
                </div>
                ...
                {stats.totalBackorderItems > 0 && stats.totalBackorderItems !== stats.backorderItems && <p className="mt-2 text-amber-400">
